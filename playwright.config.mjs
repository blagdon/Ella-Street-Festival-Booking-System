...
export default defineConfig({
  ...
  projects: [
    ...
    {
      name: 'admin',
      testMatch: /\/(admin-accessibility|focus-trap|provisioning|event-configuration|public-booking-routing|event-page-cta|settings-secrets|tenant-identity)\.spec\.mjs$/,
      dependencies: ['setup'],
