...
initPublicPage(() => {
    ...
    document.getElementById('search-input')?.addEventListener('input', (e) => handleSearch((/** @type {HTMLInputElement} */ (e.target)).value));
    document.getElementById('clear-search')?.addEventListener('click', clearSearch);
    document.getElementById('filter-select')?.addEventListener('change', (e) => applyFilter((/** @type {HTMLSelectElement} */ (e.target)).value));
