...
async function fetchFsaEstablishments(name, address = null, businessTypeId = null) {
    ...
    try {
        ...
        // Retry with spaces swapped for hyphens (or vice versa) if the plain
        // search found nothing — some FSA listings use different punctuation
        // than the trading name a stallholder gave at signup.
